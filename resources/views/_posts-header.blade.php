        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            ...
            <div x-data="{ show: false }" @click.away=" show = false">
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 w-full mt-2 rounded-xl w-full z-50"
                    ...
                    <a href="/"
                        class="block text-left px-3 text-sm leading-6 hover:bg-blue-300 focus:bg-blue-300 hover:text-white focus:text-white">All</a>
                    ...
                    @foreach ($categories as $category)
                        <a href="/categories/{{ $category->slug }}"
                            ...
                            {{ isset($currentCategory) && $currentCategory->id === $category->id ? 'bg-blue-300 text-white' : '' }}">
